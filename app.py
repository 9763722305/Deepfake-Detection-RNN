...
class validation_dataset(Dataset):
    ...
    def __getitem__(self,idx):
        ...
        for i,frame in enumerate(self.frame_extract(video_path)):
            ...
            print(f"Frame shape: {frame.shape}")  # Check if this is (height, width, 3)
    ...
    while cap.isOpened():
        ...
        if frame_count % frame_interval == 0:
            ...
            output_path = os.path.join('./static/images/', f'frame_{frame_index}.jpg')
             ...
             # Print the shape of the frame before conversion to RGB
            print(f"Frame shape: {frame.shape}")  # Should print something like (height, width, 3)
